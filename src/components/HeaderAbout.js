...
export default function HeaderAbout() {
  return (
    <div>
          ...
          <CardDeck>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Fortunate to donate clothes and food stuffs{" "}
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  A donation to women's prison during Covid{" "}
                  <a href="#learn" style={{ textDecorationLine: "underline" }}>
                    learn more...
                  </a>
                  <br />
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Sensitizing local community on the importance of{" "}
                  <a href="#learn" style={{ textDecorationLine: "underline" }}>
                    learn more...
                  </a>
                  <br />
      ...
      <div style={{ padding: "50px" }} className="mt-4 mb-5">
        {/* <img
          src={involved}
          alt="Get innvolved"
